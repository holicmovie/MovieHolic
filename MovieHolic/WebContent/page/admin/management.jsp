						...
						<div class="col-lg-4">
							<ul class="pagination"
								...
								<li class="page-item"><a class="page-link"
									href="/MovieHolic/admin?act=currentPage">1</a></li>
								<li class="page-item"><a class="page-link"
									href="/MovieHolic/admin?act=currentPage">2</a></li>
								<li class="page-item"><a class="page-link"
									href="/MovieHolic/admin?act=currentPage">3</a></li>
								<li class="page-item"><a class="page-link"
									href="/MovieHolic/admin?act=currentPage">4</a></li>
								<li class="page-item"><a class="page-link"
									href="/MovieHolic/admin?act=currentPage">5</a></li>
							</ul>
						</div>
