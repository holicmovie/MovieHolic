<%@page import="com.kitri.dto.FilmDto, java.util.List"%>
...
%>	
				...
				<article style="background-color: rgb(3, 39, 49);">
					<a href="/MovieHolic/page/film/moviedetail.jsp"
						class="image featured"><img src="<%=dto.getMovieImage()%>" alt="<%=dto.getMovieNm()%> 포스터" /></a>
					<header>
						<h5>
							<a href="/MovieHolic/page/film/moviedetail.jsp" class="font_light_small"><%=dto.getMovieNm()%></a>
						</h5>
					</header>
				</article>
<%
