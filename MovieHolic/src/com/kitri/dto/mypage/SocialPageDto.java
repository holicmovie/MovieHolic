...
public class SocialPageDto {
	...
	public SocialPageDto(int cntPerPage, int totalCnt, int cntPerPageGroup, String url, int currentPage) {
		super();
	...
	public SocialPageDto(int currentPage, int cntPerPage, int cntPerPageGroup, int totalCnt) {
		super();
